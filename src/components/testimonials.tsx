          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex items-center justify-center space-x-4">
              <Button
                ...
                className="rounded w-10 h-10 p-0 bg-transparent"
              >
              ...
              <Button
                ...
                className="rounded w-10 h-10 p-0 bg-blue-500 text-white border-blue-600 hover:bg-blue-700 hover:text-white"
              >
